...
execute as @e[type=minecraft:item_frame,nbt={Facing:1b,Item:{id:"minecraft:crafting_table"}}] at @s if block ~ ~-1 ~ minecraft:dropper run setblock ~ ~-1 ~ minecraft:dropper[facing=up]{CustomName:'{"text":"Custom Crafter","color":"dark_gray","italic":false}'}
execute as @e[type=minecraft:item_frame,nbt={Facing:1b,Item:{id:"minecraft:crafting_table"}}] at @s if block ~ ~-1 ~ minecraft:dropper run data merge block ~ ~-1 ~ {CustomName:"{\"text\":\"Custom Crafter\",\"color\":\"dark_gray\",\"italic\":false}"}
execute as @e[type=minecraft:item_frame,nbt={Facing:1b,Item:{id:"minecraft:crafting_table"}}] at @s if block ~ ~-1 ~ minecraft:dropper{Items:[]} run summon minecraft:item_frame ~ ~ ~ {Facing:1b,Invulnerable:1b,Tags:["Custom_Crafter_Core"],Item:{id:"minecraft:white_stained_glass_pane",Count:1b}}
