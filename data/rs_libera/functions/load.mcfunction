...
scoreboard objectives add rs_libera_10 dummy
...
scoreboard players set @a rs_libera_7 7
scoreboard players set @a rs_libera_0 0
scoreboard players set @a rs_libera_32767 32767