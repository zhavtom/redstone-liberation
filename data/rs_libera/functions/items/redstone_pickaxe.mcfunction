...
execute at @a[nbt={SelectedItem:{tag:{id_rs_libera:"redstone_pickaxe"}}},scores={rs_libera_dmg=..248}] store result entity @p SelectedItem.tag.Enchantments[1].lvl short 1 run scoreboard players get @p rs_libera_7
