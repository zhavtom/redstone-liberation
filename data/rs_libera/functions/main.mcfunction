...
#Resister Scores
scoreboard players set @a[scores=!{rs_libera_10=10}] rs_libera_10 10
scoreboard players set @a[scores=!{rs_libera_7=7}] rs_libera_7 7
scoreboard players set @a[scores=!{rs_libera_0=0}] rs_libera_0 0
